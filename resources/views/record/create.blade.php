...
<form class="form-horizontal" method="post" action="/record">
    <div class="form-group">
        ...
        <button type="button" class="btn btn-default col-xs-2" data-type="piss">送出</button>
    </div>
</form>
<form class="form-horizontal" method="post" action="/record">
    <div class="form-group">
        ...
        <button type="button" class="btn btn-default col-xs-2" data-type="water">送出</button>
    </div>
</form>
<form class="form-horizontal" method="post" action="/record">
    <div class="form-group">
        ...
        <button type="button" class="btn btn-default col-xs-2" data-type="food">送出</button>
    </div>
</form>
<form class="form-horizontal" method="post" action="/record">
    <div class="form-group">
